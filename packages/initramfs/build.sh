...
P_TAR=
P_URL=
P_DEPENDENCIES="busybox-initramfs libc libuuid libblkid libsmartcols libacl libattr zlib liblzo ncurses readline parted dosfstools fatresize fdisk btrfs-progs"
P_FORCE_CLEAN=yes
